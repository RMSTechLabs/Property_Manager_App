...
class _ProfileScreenState extends ConsumerState<ProfileScreen> {
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          SizedBox(width: screenWidth * 0.12, height: screenWidth * 0.12),
          // Container(
          //   width: screenWidth * 0.12,
          //   height: screenWidth * 0.12,
          // decoration: BoxDecoration(
  ...
  // Action methods
  void _editProfile(UserProfileDataModel userProfile) async {
  ...
  Future<void> _shareAddress(PropertyDetailsModel property) async {
    try {
      final userProfile = await ref.read(userProfileProvider(userId!).future);
      final addressText =
          '''Property Address: ${property.societyName}, ${property.name}, Resident: ${userProfile.name}, Contact: ${userProfile.phone} Shared via Property Manager App'''
              .trim();
  ...
  void _addFamilyMembers() {
    // //print('Add Family Members');
  }

  void _addDailyHelp() {
    // //print('Add Daily Help');
  }
  ...
  void _supportAndHelp() {
    // //print('Support and Help');
  }

  void _troubleshooting() {
